          ...
          settingsPanel.innerHTML = `
            <div class="relative w-full max-w-3xl bg-[#111827] rounded-lg overflow-hidden shadow-xl border border-gray-700/30"
              ...
              <div class="px-4 py-3 bg-gray-900/50 border-t border-gray-800 flex justify-end gap-2">
                <button class="px-4 py-2 text-xs bg-gray-800 hover:bg-gray-700 text-gray-300 rounded border border-gray-700 transition-colors">
                  Cancel
                </button>
                <button class="px-4 py-2 text-xs bg-primary/20 hover:bg-primary/30 text-primary rounded border border-primary/30 transition-colors">
                  Save Changes
                </button>
              </div>
            </div>
